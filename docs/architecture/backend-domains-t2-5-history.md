> Historical record: the following T2.5/P8 map is preserved from before AR-B8 closeout. It describes the previous staged architecture. For current contributor rules use [Backend Architecture](../../backend/ARCHITECTURE.md) and the [current domain map](backend-domains.md).

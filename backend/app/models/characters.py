...
class Character(Base):
    ...
    moderation_updated_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    ...
    image_generation_setting: Mapped[Optional["AgentImageGenerationSetting"]] = relationship(
        back_populates="character", uselist=False
    )

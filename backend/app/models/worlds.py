"""World model compatibility surface during the L3 migration.

World Creator persistence is canonical under ``app.domains.worlds``. The two
WorldCharacter tables stay here until their own boundary moves in PR C.
"""

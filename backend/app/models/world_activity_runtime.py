...
class JointActivity(Base):
    ...
    source_proposal_event_id: Mapped[str | None] = mapped_column(String(64))
    source_acceptance_event_id: Mapped[str | None] = mapped_column(String(64))
...
class DailyActivityPlanItem(Base):
    ...
    selected_candidate_id: Mapped[str] = mapped_column(
        ForeignKey("world_activity_candidates.id"), nullable=False
    )
    candidate_signature: Mapped[str] = mapped_column(String(64), nullable=False)
...
class ActivityEventConsumption(Base):
    ...
    source_social_event_id: Mapped[str] = mapped_column(String(64), nullable=False)

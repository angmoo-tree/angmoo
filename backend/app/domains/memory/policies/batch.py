...
MEMORY_BATCH_POLICY_VERSION = "memory-batch.v3"
MEMORY_BATCH_LEASE_DURATION = timedelta(seconds=240)
MEMORY_SELECTION_VERSION = "memory-selection.v2"
MAX_SELECTION_CANDIDATES = 32
MAX_SELECTION_INPUT_CHARACTERS = 240_000
MAX_SELECTION_OUTPUT_TOKENS = 65_536
MAX_SELECTION_SUMMARY_CHARACTERS = 120
MAX_SELECTION_INPUT_UTF8_BYTES = 720_000
MAX_SELECTION_INPUT_TOKEN_BOUND = 1_000_000
SELECTION_TOKEN_SPECIAL_RESERVE = 512
MEMORY_SHUTDOWN_SECONDS = 185
MEMORY_FINALIZE_RESERVE_SECONDS = 5
MEMORY_PROVIDER_TIMEOUT_SECONDS = 180

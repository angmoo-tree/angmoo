...
class WorldFeedWorkflows(Protocol):
    def refresh_social_context(self, ctx: WorldFeedContext, *, counterpart_id: str | None = None) -> WorldFeedContext: ...
    def validate_candidate_relationships(self, db: Session, profile: ReadySearchProfile,
                                         candidates: tuple[schemas.WorldFeedCandidateRead, ...]) -> None: ...
    def refresh_candidate_relationships(self, db: Session, profile: ReadySearchProfile,
                                        candidates: tuple[schemas.WorldFeedCandidateRead, ...]) -> tuple[schemas.WorldFeedCandidateRead, ...]: ...
    @property

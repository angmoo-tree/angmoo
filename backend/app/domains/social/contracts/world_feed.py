...
class FeedApprovedRepertoire(Protocol):
    @property
    def world_character_id(self) -> str: ...
    @property
    def status(self) -> str: ...
    ...
    def world_contract_hash(self) -> str: ...
    @property
    def community_profile_id(self) -> str: ...
...
class WorldFeedReferences(Protocol):
    def recommendation_candidates(self, *, profile: ReadySearchProfile, allowed_policy_actions, now: datetime) -> CandidateSearchResult: ...
    ...
    def approved_pair_matches_world(self, world_character, profile, repertoire, *, world_hash: str) -> bool: ...

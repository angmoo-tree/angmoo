...
class Settings(BaseSettings):
    ...
    ACTIVITY_THOUGHT_POLICY: Literal["legacy", "thought_v1"] = "legacy"
    MEMORY_RECALL_REPRESENTATION: Literal["legacy", "episode_v1"] = "legacy"
    MEMORY_GENERATION_POLICY: Literal["legacy", "episode_v1"] = "legacy"

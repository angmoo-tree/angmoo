...
from app.domains.memory.service import batch_preparation, batch_scheduling, reconciliation
...
reconcile_sources = partial(reconciliation.reconcile_sources, dependencies=build_preparation_dependencies())

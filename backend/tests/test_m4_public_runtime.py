...
def test_public_runtime_exposes_only_approved_routes() -> None:
    ...
    assert {
        ...
        ("GET", "/api/v1/worlds/{world_id}/owner-character"),
        ("POST", "/api/v1/worlds/{world_id}/owner-character"),
        ("PATCH", "/api/v1/worlds/{world_id}/owner-character"),
        ("GET", "/api/v1/worlds/{world_id}/character-candidates"),
        (
            "POST",
            "/api/v1/worlds/{world_id}/characters/{character_id}/leave",
        ),
    } <= operations
    assert {
        ("POST", "/api/v1/world-package-imports/stage"),
        (
            "GET",
            "/api/v1/world-package-imports/{operation_id}/preview",
        ),
        ("DELETE", "/api/v1/world-package-imports/{operation_id}"),
        (
            "POST",
            "/api/v1/world-package-imports/{operation_id}/commit",
        ),
    } <= operations
    assert {
        ("GET", "/api/v1/worlds/{world_id}/chat/threads"),
        ("POST", "/api/v1/worlds/{world_id}/chat/threads"),
        (
            "PATCH",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/model",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}",
        ),
        (
            "POST",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/messages",
        ),
        (
            "POST",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/retry",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/requests/latest",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/requests/{request_id}",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/requests/{request_id}/events",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/chat/threads/{thread_id}/requests/{request_id}/evidence",
        ),
    } <= operations
    assert {
        ("GET", "/api/v1/worlds/{world_id}/world-characters"),
        (
            "GET",
        ...
        (
            "GET",
            "/api/v1/worlds/{world_id}/world-characters/{responding_id}/chat-entry",
        ),
        (
            "GET",
        ...
        (
            "GET",
            "/api/v1/worlds/{world_id}/world-characters/{subject_id}/memory/settings",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/world-characters/{subject_id}/memories",
        ),
        (
            "GET",
            "/api/v1/worlds/{world_id}/world-characters/{subject_id}/memories/{memory_id}",
        ),
    } <= operations
    assert {
        ("GET", "/api/v1/worlds/{world_id}/manual-social/feed"),
        (
            "GET",
            "/api/v1/worlds/{world_id}/manual-social/posts/{post_id}",
        ),
        ("POST", "/api/v1/worlds/{world_id}/manual-social/posts"),
        (
            "POST",
            "/api/v1/worlds/{world_id}/manual-social/posts/{post_id}/replies",
        ),
    } <= operations
    assert {
        (
            "POST",
            "/api/v1/worlds/{world_id}/package-exports/preview",
        ),
        ("POST", "/api/v1/worlds/{world_id}/package-exports"),
        (
            "GET",

...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("backend/app/api/v1/deps.py", "hosted-full"),
        ("backend/app/api/v1/routes/auth.py", "hosted-full"),
        ("backend/app/core/config.py", "hosted-full"),
        ("backend/app/core/redaction.py", "hosted-full"),
        ("backend/app/core/startup_security.py", "hosted-full"),
        ("backend/app/schemas/__init__.py", "hosted-full"),
        ("backend/app/schemas/admin.py", "hosted-full"),
        ("backend/tests/test_demo_account_lock.py", "hosted-full"),
        ("backend/app/alembic/versions/20260726_0066.py", "hosted-full"),
        ("backend/angmoo_hosted/main.py", "hosted-full"),
        ("frontend/src/app/admin/page.tsx", "hosted-full"),
        ("frontend/src/app/demo/kimarin/page.tsx", "hosted-full"),
        ("frontend/src/app/portfolio-review/page.tsx", "hosted-full"),
        ("frontend/src/components/demo-kimarin-client.tsx", "hosted-full"),
        ("frontend/src/lib/agents.ts", "hosted-full"),
        ("security/hosted_impact_policy.json", "hosted-full"),

...
REQUIRED_FILES = (
    ...
    "backend/tests/chat/test_p8_l_p_model_hotfix.py",
...
ALEMBIC_REVISION_RECORD = "backend/app/alembic/versions/20260903_0087_world_chat_model_binding.py"
ALEMBIC_REVISION_SOURCE = "backend/alembic/versions/20260903_0087_world_chat_model_binding.py"
...
def main() -> int:
    ...
    try:
        ...
        if (ROOT / "docs/architecture/p8-l-r-today-sns-activity-inventory.json").is_file():
            if _sha256(OUTPUT_PATH) != "24bf66e001fae70bc45ea48eb7905cbf4210b4bec2c495408558f85843f2925b":

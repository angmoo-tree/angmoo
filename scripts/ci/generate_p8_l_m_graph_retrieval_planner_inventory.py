...
L_INVENTORY_SHA256 = (
    "9d99c2f72ddb6ca9d0befb027f93746b226243f4f95cbe3d853202cc26aa8e27"
)
...
def main() -> int:
    ...
    try:
        ...
        if (ROOT / "docs/architecture/p8-l-r-today-sns-activity-inventory.json").is_file():
            if _sha256(OUTPUT_PATH) != "2ed92b329b7c63365911e79aa3b431c5ca1e1d77bcef3a3736da9a3d81e0e3bd":

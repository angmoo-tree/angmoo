...
- exact base는 P8-L-C merge `8a83f48ed565992f8c3e7dd1dbe958f33997e7ab`이며 Issue `#218`, branch `feat/p8-l-d-world-chat-identity-role-binding`에서 구현한다. local technical Gate는 PASS했고 push·Draft PR·Hosted CI·사용자·merge·post-merge Gate는 아직 닫히지 않았다.

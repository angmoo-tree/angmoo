import { fetchAuthenticatedMediaObjectUrl } from "@/lib/media/authenticated-media";
import { type AgentCreationDraftMediaResult } from "@/features/characters/types/agents";

...
const stages: Record<string, string> = { LoadContext: "현재 상황 확인 중", LoadCandidates: "확인할 대상 준비 중", TargetSelector: "살펴볼 대상 선택 중", ResolveQuery: "기억 검색 준비 중", RecallSelected: "관련 기억 확인 중", BuildDecisionContext: "행동 판단 자료 준비 중", ActionPlanner: "반응 판단 중", ValidateDecision: "판단 결과 확인 중", Writer: "글 작성 중", Execute: "행동 실행 중", Settle: "경험 반영 중", PathResult: "활동 결과 정리 중", Resume: "이전 작업 이어가는 중", Finalize: "실행 결과 정리" };
